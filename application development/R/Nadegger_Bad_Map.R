...
# extract the raster layer for january
rain_month <- precipitation[[1]]

# get the shapefile of africa from natural earth and validate it
...
# convert raster to dataframe so ggplot understands it
...
# i hope it is obvious that this is the map with less effort. i didnt really do a lot here. i basically only:
...
# -> as last step for preparation i converted the cropped layer into  a dataframe to i was able to plot it with ggplot. 
